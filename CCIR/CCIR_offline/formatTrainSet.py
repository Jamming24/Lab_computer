...
def getCool_user_test(testfile, cool_user, Outfile, hot_out_file):
    cool_lines = []
    hot_lines = []
    file = open(testfile, 'r', encoding='UTF-8')
    OutFile_object = open(Outfile, 'w', encoding='UTF-8')
    Hot_file_object = open(hot_out_file, 'w', encoding='UTF-8')
    for line in file:
        user = line.split('\t')[0]
...
def getCool_user_train(lessFocusIDfile, lessBehaviorIDfile, purity_train_file, cool_user_out_file, hot_user_out_file):
    ...
    lessfocus_list = lessfocus_list_object.readlines()
    lessBehaviorID_list = lessBehaviorIDfile_object.readlines()
...
if __name__ == '__main__':
    train_file = "E:\\small_data\\training_set_Part.txt"
    dictfile = "E:\\CCIR\\answer_id.dict"
    OutPath = "E:\\CCIR\\purity_training_set.txt"
    user_info_file = "F:\\CCIR\\可计算数据\\competition\\user_infos.txt"
    cool_user_file = "E:\\CCIR\\focusOnlessThressUserID.txt"
    test_file = "E:\\CCIR\\available_new_testing_set.txt"
    cool_user_test = "E:\\CCIR\\cool_user_available_new_testing_set.txt"
    hot_user_test = "E:\\CCIR\\hot_user_available_new_testing_set.txt"
    cool_user_train_ID_file = "E:\\CCIR\\cool_user_train_ID.txt"
    ...
    lessFocusIDfile = "E:\\CCIR\\focusOnlessThressUserID.txt"
    lessBehaviorIDfile = "E:\\only_behavior_query_cool_user_train_ID.txt"
    purity_train_file = "E:\\purity_training_set.txt"
    cool_user_out_file = "E:\\cool_user_train_set.txt"
    hot_user_out_file = "E:\\hot_user_train_set.txt"
    getCool_user_train(lessFocusIDfile, lessBehaviorIDfile, purity_train_file, cool_user_out_file, hot_user_out_file)
