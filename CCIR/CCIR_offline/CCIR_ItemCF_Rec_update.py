...
def multiprocessing_manager(User_Behavior_Dict, Item_Similary_dict, n, k):
    ...
    for userID in User_Behavior_Dict.keys():
        if len(temp_User_Behavior_Dict) == 100:
...
if __name__ == '__main__':
    ...
    small_test_file = "F:\\BaiduNetdiskDownload\\20180726\\testing_set_20180725_RecSys_flappyBird.txt"
    csv_out_file = "E:\\CCIR\\ItemCF_online_result.csv"
    answer_id_dict_file = "F:\\BaiduNetdiskDownload\\20180726\\answer_id_20180725.dict"
    recommand_list_file = "E:\\CCIR\\ItemCF_online_Word2Vector_RecommendList.txt"
    ...
    # 5是进程数量 20是与Item最相关的数量
    User_Recommond_Dict = multiprocessing_manager(User_Behavior_Dict, Item_Similary_dict, 5, 120)
