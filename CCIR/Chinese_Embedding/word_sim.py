...
def read_vectors(vec_file):
    ...
    # word_size表示词表大小，embed_dim 词嵌入维度，dict_word词典
...
if __name__ == '__main__':
    ...
    # 评价文件路径
    fname1 = "C:\\Users\\Jamming_Lab\Desktop\\词向量评价程序\\297.txt"
    # 词向量文件路径
    vec_file = "F:\\迅雷下载\\simply_wiki_add_component_Ansj_Segment_wiki_vector_gensim.txt"
    try:
